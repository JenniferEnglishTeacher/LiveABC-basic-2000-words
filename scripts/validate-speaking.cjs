...
assert(!speech.includes("fetch("));console.log(`Validated 11 units, ${count} sample sentences, target-word forms, required spelling, optional speech recognition, and JavaScript syntax.`);